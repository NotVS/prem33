...
selected_club = st.selectbox("Choose Club", dataframe['Team'].unique())


st.siderbar.ubheader("Filter by Position")
selected_position = st.selectbox("Choose Position", dataframe['Pos'].unique())

st.subheader("Filter by Player Name")
selected_player = st.text_input("Enter Player Name", placeholder = "e.g Mohammed Salah")

st.subheader("Filter by Nation")
selected_nation = st.text_input("Enter Nation", placeholder = "e.g  eng ENG")
