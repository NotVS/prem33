...
selected_player = st.sidebar.text_input("Enter Player Name", placeholder = "e.g Mohammed Salah")
...
def filter_dataframe(df, selected_club, selected_position, selected_player, selected_nation):
    ...
    if selected_player:
        filtered_df = filtered_df[filtered_df['Player'].str.contains(selected_player, case=False, na=False)]
